...
#include "agri_interfaces/msg/detail/soil_moisture__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agri_interfaces::msg::SoilMoisture;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agri_interfaces::msg::SoilMoisture *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agri_interfaces::msg::SoilMoisture *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SoilMoisture__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const agri_interfaces::msg::SoilMoisture *>(
...
static size_t _SoilMoisture__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SoilMoisture(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SoilMoisture__callbacks = {
  "agri_interfaces::msg",
  "SoilMoisture",
...
static rosidl_message_type_support_t _SoilMoisture__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SoilMoisture__callbacks,
...
{
  return &agri_interfaces::msg::typesupport_fastrtps_cpp::_SoilMoisture__handle;
}
