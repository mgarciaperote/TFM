...
#include "agri_interfaces/msg/detail/robot_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agri_interfaces::msg::RobotCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agri_interfaces::msg::RobotCommand & ros_message)
{
  // Member: timestamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agri_interfaces::msg::RobotCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agri_interfaces::msg::RobotCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agri_interfaces::msg::RobotCommand *>(
    untyped_ros_message);
...
{
  return &agri_interfaces::msg::typesupport_fastrtps_cpp::_RobotCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agri_interfaces, msg, RobotCommand)() {
  return &agri_interfaces::msg::typesupport_fastrtps_cpp::_RobotCommand__handle;
}
