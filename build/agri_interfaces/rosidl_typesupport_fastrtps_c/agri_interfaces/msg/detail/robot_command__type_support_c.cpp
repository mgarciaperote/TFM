...
#include "agri_interfaces/msg/detail/robot_command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // command, robot_id
#include "rosidl_runtime_c/string_functions.h"  // command, robot_id
...
using _RobotCommand__ros_msg_type = agri_interfaces__msg__RobotCommand;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agri_interfaces
bool cdr_serialize_agri_interfaces__msg__RobotCommand(
  const agri_interfaces__msg__RobotCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agri_interfaces
bool cdr_deserialize_agri_interfaces__msg__RobotCommand(
  eprosima::fastcdr::Cdr & cdr,
  agri_interfaces__msg__RobotCommand * ros_message)
{
  // Field name: timestamp
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agri_interfaces
size_t get_serialized_size_agri_interfaces__msg__RobotCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agri_interfaces
size_t max_serialized_size_agri_interfaces__msg__RobotCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agri_interfaces__msg__RobotCommand;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agri_interfaces
bool cdr_serialize_key_agri_interfaces__msg__RobotCommand(
  const agri_interfaces__msg__RobotCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agri_interfaces
size_t get_serialized_size_key_agri_interfaces__msg__RobotCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotCommand__ros_msg_type * ros_message = static_cast<const _RobotCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agri_interfaces
size_t max_serialized_size_key_agri_interfaces__msg__RobotCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const agri_interfaces__msg__RobotCommand * ros_message = static_cast<const agri_interfaces__msg__RobotCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_agri_interfaces__msg__RobotCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  agri_interfaces__msg__RobotCommand * ros_message = static_cast<agri_interfaces__msg__RobotCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_agri_interfaces__msg__RobotCommand(cdr, ros_message);
}

static uint32_t _RobotCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_agri_interfaces__msg__RobotCommand(
...
static size_t _RobotCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agri_interfaces__msg__RobotCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agri_interfaces, msg, RobotCommand)() {
