...
bool agri_interfaces__msg__soil_moisture__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agri_interfaces.msg._soil_moisture", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("SoilMoisture", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  agri_interfaces__msg__SoilMoisture * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of SoilMoisture */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agri_interfaces.msg._soil_moisture");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SoilMoisture");
