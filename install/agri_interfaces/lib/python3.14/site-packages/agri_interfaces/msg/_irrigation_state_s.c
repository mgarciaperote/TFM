...
bool agri_interfaces__msg__irrigation_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agri_interfaces.msg._irrigation_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("IrrigationState", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  agri_interfaces__msg__IrrigationState * ros_message = _ros_message;
  {  // sensor_timestamp
  ...
  {  // state_timestamp
    PyObject * field = PyObject_GetAttrString(_pymsg, "state_timestamp");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__time__convert_from_py(field, &ros_message->state_timestamp)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of IrrigationState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agri_interfaces.msg._irrigation_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IrrigationState");
  ...
  {  // state_timestamp
    PyObject * field = NULL;
    field = builtin_interfaces__msg__time__convert_to_py(&ros_message->state_timestamp);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "state_timestamp", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
